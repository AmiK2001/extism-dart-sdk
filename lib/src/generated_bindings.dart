...
class LibExtism {
  ...
  /// host context.
  ffi.Pointer<ffi.Void> extism_current_plugin_host_context(
    ffi.Pointer<ExtismCurrentPlugin> plugin,
  ) {
    return _extism_current_plugin_host_context(
      plugin,
    );
  }

  late final _extism_current_plugin_host_contextPtr = _lookup<
          ffi.NativeFunction<
              ffi.Pointer<ffi.Void> Function(
                  ffi.Pointer<ExtismCurrentPlugin>)>>(
      'extism_current_plugin_host_context');
  late final _extism_current_plugin_host_context =
      _extism_current_plugin_host_contextPtr.asFunction<
          ffi.Pointer<ffi.Void> Function(ffi.Pointer<ExtismCurrentPlugin>)>();
  ...
  ffi.Pointer<ExtismFunction> extism_function_new(
    ...
    ffi.Pointer<ffi.UnsignedInt> inputs,
    int n_inputs,
    ffi.Pointer<ffi.UnsignedInt> outputs,
    int n_outputs,
  ...
  ffi.Pointer<ExtismCompiledPlugin> extism_compiled_plugin_new(
    ...
    return _extism_compiled_plugin_new(
      wasm,
      wasm_size,
      functions,
      n_functions,
  ...
  late final _extism_compiled_plugin_newPtr = _lookup<
          ffi.NativeFunction<
              ffi.Pointer<ExtismCompiledPlugin> Function(
  ...
  late final _extism_compiled_plugin_new =
      _extism_compiled_plugin_newPtr.asFunction<
          ffi.Pointer<ExtismCompiledPlugin> Function(
              ffi.Pointer<ffi.Uint8>,
              int,
              ffi.Pointer<ffi.Pointer<ExtismFunction>>,
  ...
  void extism_compiled_plugin_free(
    ffi.Pointer<ExtismCompiledPlugin> plugin,
  ) {
    return _extism_compiled_plugin_free(
      plugin,
    );
  }

  late final _extism_compiled_plugin_freePtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Pointer<ExtismCompiledPlugin>)>>(
      'extism_compiled_plugin_free');
  late final _extism_compiled_plugin_free = _extism_compiled_plugin_freePtr
      .asFunction<void Function(ffi.Pointer<ExtismCompiledPlugin>)>();
  ...
  ffi.Pointer<ExtismPlugin> extism_plugin_new_from_compiled(
    ffi.Pointer<ExtismCompiledPlugin> compiled,
    ffi.Pointer<ffi.Pointer<ffi.Char>> errmsg,
  ) {
    return _extism_plugin_new_from_compiled(
      compiled,
      errmsg,
    );
  }

  late final _extism_plugin_new_from_compiledPtr = _lookup<
          ffi.NativeFunction<
              ffi.Pointer<ExtismPlugin> Function(
                  ffi.Pointer<ExtismCompiledPlugin>,
                  ffi.Pointer<ffi.Pointer<ffi.Char>>)>>(
      'extism_plugin_new_from_compiled');
  late final _extism_plugin_new_from_compiled =
      _extism_plugin_new_from_compiledPtr.asFunction<
          ffi.Pointer<ExtismPlugin> Function(ffi.Pointer<ExtismCompiledPlugin>,
              ffi.Pointer<ffi.Pointer<ffi.Char>>)>();

  /// Create a new plugin and set the number of instructions a plugin is allowed to execute
  ffi.Pointer<ExtismPlugin> extism_plugin_new_with_fuel_limit(
    ffi.Pointer<ffi.Uint8> wasm,
    int wasm_size,
    ffi.Pointer<ffi.Pointer<ExtismFunction>> functions,
    int n_functions,
    ...
    return _extism_plugin_new_with_fuel_limit(
      wasm,
      wasm_size,
      functions,
      n_functions,
  ...
  late final _extism_plugin_new_with_fuel_limitPtr = _lookup<
          ffi.NativeFunction<
              ffi.Pointer<ExtismPlugin> Function(
                  ffi.Pointer<ffi.Uint8>,
                  ExtismSize,
  ...
  late final _extism_plugin_new_with_fuel_limit =
      _extism_plugin_new_with_fuel_limitPtr.asFunction<
          ffi.Pointer<ExtismPlugin> Function(
              ffi.Pointer<ffi.Uint8>,
              int,
              ffi.Pointer<ffi.Pointer<ExtismFunction>>,
  ...
  void extism_plugin_allow_http_response_headers(
    ffi.Pointer<ExtismPlugin> plugin,
  ) {
    return _extism_plugin_allow_http_response_headers(
      plugin,
    );
  }

  late final _extism_plugin_allow_http_response_headersPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ExtismPlugin>)>>(
          'extism_plugin_allow_http_response_headers');
  late final _extism_plugin_allow_http_response_headers =
      _extism_plugin_allow_http_response_headersPtr
  ...
  int extism_plugin_call_with_host_context(
    ffi.Pointer<ExtismPlugin> plugin,
    ffi.Pointer<ffi.Char> func_name,
    ffi.Pointer<ffi.Uint8> data,
    int data_len,
    ffi.Pointer<ffi.Void> host_context,
  ) {
    return _extism_plugin_call_with_host_context(
      plugin,
      func_name,
      data,
      data_len,
  ...
  late final _extism_plugin_call_with_host_contextPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<ExtismPlugin>,
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Uint8>,
              ExtismSize,
              ffi.Pointer<ffi.Void>)>>('extism_plugin_call_with_host_context');
  late final _extism_plugin_call_with_host_context =
      _extism_plugin_call_with_host_contextPtr.asFunction<
          int Function(ffi.Pointer<ExtismPlugin>, ffi.Pointer<ffi.Char>,
...
enum ExtismValType {
  ...
  /// A 128 bit number.
  ExtismValType_V128(4),

  /// A reference to a Wasm function.
  ExtismValType_FuncRef(5),

  /// A reference to opaque data in the Wasm instance.
  ExtismValType_ExternRef(6);

  final int value;
  const ExtismValType(this.value);

  static ExtismValType fromValue(int value) => switch (value) {
        0 => ExtismValType_I32,
        1 => ExtismValType_I64,
        2 => ExtismValType_F32,
        3 => ExtismValType_F64,
        4 => ExtismValType_V128,
        5 => ExtismValType_FuncRef,
        6 => ExtismValType_ExternRef,
        _ => throw ArgumentError("Unknown value for ExtismValType: $value"),
      };
}

final class ExtismCancelHandle extends ffi.Opaque {}

final class ExtismCompiledPlugin extends ffi.Opaque {}
...
final class ExtismVal extends ffi.Struct {
  ...
  ExtismValType get t => ExtismValType.fromValue(tAsInt);
